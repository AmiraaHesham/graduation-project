    ...
    <div>
      ...
      <div className='side-bar'>
        <Link to={"/LecturesDates"} style={{ textDecoration: 'none', color: '#1D2649' }}>
          <div className='Lecture-Dates-SAOverAll'>
        ...
        <Link to={"/CurrentClass"} style={{ textDecoration: 'none', color: '#1D2649' }}>
          <div className='Current-Class-SAOverAll'>
            <h2>Current Class</h2>
        ...
        <Link to={"/Timetable"} style={{ textDecoration: 'none', color: '#1D2649' }}>
          <div className='Timetable-SAOverAll'>
            <h2>Timetable</h2>
        ...
        <Link to={'/Weekly'} style={{ textDecoration: 'none', color: '#1D2649' }}><div className='div-Weekly-OverAll'>
