    ...
    return (
        <div className='body'>
            ...
            <div className='side-bar'>
                ...
                <Link to={"/CurrentClass"} style={{ textDecoration: 'none', color: '#1D2649' }}><div className='Current-Class-LectureDates'>
                    <h2>Current Class</h2>
                ...
                <Link to={"/Timetable"} style={{ textDecoration: 'none', color: '#1D2649' }}> <div className='Timetable-LectureDates'>
                    <h2>Timetable</h2>
                ...
                <Link to={"/OverAll"} style={{ textDecoration: 'none', color: '#1D2649' }}>   <div className='Students-Attendance-LectureDates'>
